...
-- loinc
select loinc_num, long_common_name, shortname from loinc.loinc l where long_common_name ~* 'airway.+pressure' order by long_common_name ;
...
select * from copra.co6_config_variables ccv where id = 104247;
